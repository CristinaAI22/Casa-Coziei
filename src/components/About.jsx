...
export default function About() {
  ...
  return (
    <section id="about" className="py-16 bg-gray-100 relative">
      ...
      {/* Pop-up Above Content */}
      {isOpen && (
        <div className="absolute left-1/2 top-20 transform -translate-x-1/2 w-[500px] bg-white p-6 rounded-lg shadow-xl border border-gray-300 z-20 animate-fade-in">
          <button
