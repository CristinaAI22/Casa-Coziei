    ...
    <section id="about" className="py-16 bg-gray-100">
      <div className="max-w-6xl mx-auto px-4 text-center">
        ...
        <p className="mt-4 text-lg text-gray-600 text-justify">
          ...
          harnică și îndemânatică, s-a apucat să coacă pâine, să facă cele mai
          delicioase ciorbe, să combine rețete locale cu ingrediente noi, să
          împletească cozonaci, să facă muraturi, vișinată, liomanadă. Așa își
          hrănește ea familia și prietenii, cu iubire pusă în mâncare. Pasiunea
          pentru gastronomia locală și plăcerea de a experimenta mereu vechi
          rețete, a făcut să încolțească ideea că la ei acasă s-ar putea servi
          mâncare de te lingi pe degete pentru turiștii care vin în zonă.
        </p>
      </div>
